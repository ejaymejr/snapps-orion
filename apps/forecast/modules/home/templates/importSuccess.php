...
<table width="844" border="0" bordercolor="#CCFF00">
   ...
   <tr>
     ...
     <th rowspan="2" bgcolor="#FFFFFF"><div align="center">FINANCIAL REPORT </div></th>
     <td height="80" bgcolor="#D8CFFE"><div align="center" class="tk-style16">
     
     <?php
     echo link_to('Daily Sales vs Cost Breakdown', 'reports/dailyIncomeExpense');
     ?> 
   ...
   <tr>
     ...
     <?php
     echo link_to('Cost vs Sales Monthly Trend', 'reports/trendIncomeExpense');
     ?> 
