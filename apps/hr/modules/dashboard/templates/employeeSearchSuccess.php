...
<tr>
	...
	<td class="">
		<?php echo HTMLLib::CreateSelect('status', $sf_params->get('status'), array('A' => ' - ACTIVE -', '' => ' - ALL - '), 'span2'); ?>
...
if (isset($pager))
{
	...
	$cols = array('seq', 'action', 'employee_no', 'name', 'company', 'account_no', 'joined-date', 'work-schedule', 'type', 'mom');
