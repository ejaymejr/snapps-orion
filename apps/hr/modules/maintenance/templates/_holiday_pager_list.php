...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignLeft alignTop" nowrap ><?php echo $record->getHoliday() ?></td>
    <td class="alignLeft alignTop" nowrap ><?php echo $record->getDateHol() ?></td>    
