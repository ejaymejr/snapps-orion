...
$desc = $record->getName().' - '.$record->getLeaveType();
$editLink = 'Edit';
$deleteLink = 'Delete';
$editLink = link_to('Edit', 'maintenance/individualLeaveEdit?id=' . $record->getId());
  
$deleteLink = link_to('Delete', 'maintenance/individualLeaveDelete?id=' . $record->getId(),
...
<tr class="<?=$rowClass?>"
    ...
    <td class="alignLeft alignTop" nowrap ><?php echo $record->getFiscalYear() ;//HrIndividualLeavePeer::GetFlagStatus($record->getStatus()) ?></td>
