...
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('payroll/payrollTrend'). '?id=' . $sf_params->get('id');?>"
	method="post">
	...
	<div class="panel " data-role="panel">
	    ...
	    <div class="panel-content" style="display: none;" >
			...
			if (isset($pager))
			{
			    ...
			    $filename = hrPager::PayrollTrendSearchEmployee($pager, $employeeList);
		...
		<table class="bordered table condensed hovered">
			...
			<tr class="<?php echo HrEmployeePeer::IsResigned($empno)? 'bg-clearRed ' : '' ?>">
				...
				<?php foreach($months as $month):?>
					<td class="alignRight">
						<small>
							<a href="#" data-hint="basic pay"><?php echo number_format($monthlyData[$month][$empno]['basic'] ,2) ;  ?></a>
						+	<a href="#" data-hint="overtime"><?php echo number_format($monthlyData[$month][$empno]['ot'],2) ;  ?></a>
						+	(<a href="#" data-hint="cpf-employee share(deducted from basic)"><?php echo number_format($monthlyData[$month][$empno]['cpf_em'] * -1, 2) ;  ?></a>)
						+	<a href="#" data-hint="cpf-employer share"><?php echo number_format($monthlyData[$month][$empno]['cpf_er'] * -1, 2) ;  ?></a>
						+	<a href="#" data-hint="foreign workers levy"><?php echo number_format($monthlyData[$month][$empno]['levy'], 2) ;  ?></a>
		...
		<table class="bordered table condensed hovered">
			...
			<tr  class="bg-clearRed alignRight">
				...
				<?php foreach($months as $month):?>
					...
					?></small></td>
				<?php endforeach;?>
				<td ><small><?php echo number_format($grossArticle ); ?></small></td>
			</tr>
		</table>
