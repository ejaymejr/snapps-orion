...
<div class="panel-content">
	<table class="table bordered" >
		...
		<tr>
			...
			<td>
			<?php 
				echo HTMLLib::CreateSelect('empno', $sf_params->get('empno'), $empList); 
			?>
			</td>
		</tr>
		<tr>
			<td class="FORMcell-left FORMlabel bg-clearBlue span1" nowrap><label>Source</label></td>
			<td>
			<?php 
				$source = array('taxable'=>' - Taxable (bank/check)- ' , 'all'=>' - All (bank/cash/check)- ', 'bank'=>' - Bank - ', 'cash'=>' - Cash - ', 'cheque'=>' - Check - ' );
				echo HTMLLib::CreateSelect('source', $sf_params->get('source'), $source, 'span4'); 
			?>
			</td>
		</tr>
		<tr>
