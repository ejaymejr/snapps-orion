...
<form name="FORMadd" id="IDFORMadd" action="<?php echo url_for('expenses/powerConsumptionAdd'). '?id=' . $sf_params->get('id');?>" method="post">
<table class="table bordered condensed">
<tr class="bg-clearGreen">
	<td colspan="5"><h4>POWER CONSUMPTION ENTRY SHEET</h4></td>
</tr>
<tr>
