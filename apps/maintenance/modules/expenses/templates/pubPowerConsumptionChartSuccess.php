...
<form name="FORMadd" id="IDFORMadd" action="<?php echo url_for('expenses/pubPowerConsumptionChart'). '?id=' . $sf_params->get('id');?>" method="post">
...
<tr>
    ...
    <td class="FORMcell-right" nowrap>
    <input type="submit" name="power" value=" Show PUB Power Consumption " class="success">
    </td>
</tr>
</table>
</form>
...
<?php 
if (isset($benchmark)):
	include_partial('pubpower_consumption_chart', array('chartData'=> $chardataJson ));
endif;
?>
</div>