...
<form name="FORMadd" id="IDFORMadd" action="<?php echo url_for('expenses/pubWaterConsumptionAdd'). '?id=' . $sf_params->get('id');?>" method="post">
<table class="table bordered condensed">
<tr class="bg-clearGreen">
	<td colspan="5"><h4>SP SERVICES WATER CONSUMPTION ENTRY SHEET</h4></td>
</tr>
<tr>
