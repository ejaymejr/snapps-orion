...
list($class, $parameters) = (array) sfConfig::get('sf_snappsGlobal_filter', array('snappsGlobalHTMLPathFilter', null));
$filter = new $class();
$filter->initialize($this->context, $parameters);
$filterChain->register($filter);
...
list($class, $parameters) = (array) sfConfig::get('sf_snapps_filter', array('snappsFilter', null));
$filter = new $class();
$filter->initialize($this->context, $parameters);
$filterChain->register($filter);
