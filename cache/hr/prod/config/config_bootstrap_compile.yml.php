...
// date: 2016/01/22 12:19:01
sfConfig::add(array(
  'sf_default_module' => 'snappsDefault',
  'sf_default_action' => 'index',
  'sf_error_404_module' => 'snappsDefault',
  'sf_error_404_action' => 'error404',
  'sf_login_module' => 'sfGuardAuth',
  'sf_login_action' => 'signin',
  'sf_secure_module' => 'snappsDefault',
...
$log->initialize(array (
  'file' => '/opt/sites/int/app.micronclean/symfony/snapps-orion/log/hr_prod.log',
));
...
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "magic_quotes_gpc" key is better set to "false" (current value is "\'\'" - php.ini location: "/opt/php/lib/php.ini").');
}
if (ini_get('register_globals') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "register_globals" key is better set to "false" (current value is "\'\'" - php.ini location: "/opt/php/lib/php.ini").');
}
if (ini_get('session.auto_start') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "session.auto_start" key is better set to "false" (current value is "\'0\'" - php.ini location: "/opt/php/lib/php.ini").');
}
