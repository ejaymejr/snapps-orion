...
class FinanceSummaryMapBuilder {

	
	const CLASS_NAME = 'lib.model.forecast.map.FinanceSummaryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('finance_summary');
		$tMap->setPhpName('FinanceSummary');
