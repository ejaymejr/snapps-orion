...
class PowerUsageBackupMapBuilder {

	
	const CLASS_NAME = 'lib.model.forecast.map.PowerUsageBackupMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('power_usage_backup');
		$tMap->setPhpName('PowerUsageBackup');
