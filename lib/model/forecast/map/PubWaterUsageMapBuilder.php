...
class PubWaterUsageMapBuilder {

	
	const CLASS_NAME = 'lib.model.forecast.map.PubWaterUsageMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pub_water_usage');
		$tMap->setPhpName('PubWaterUsage');
