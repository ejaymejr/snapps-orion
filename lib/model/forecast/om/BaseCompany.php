...
abstract class BaseCompany extends BaseObject  implements Persistent {
	...
	public function setCompCode($v)
	{
		...
		if ($this->comp_code !== $v || $v === 'null') {
			$this->comp_code = $v;
			$this->modifiedColumns[] = CompanyPeer::COMP_CODE;
		}
	...
	public function setCompName($v)
	{
		...
		if ($this->comp_name !== $v || $v === 'null') {
			$this->comp_name = $v;
			$this->modifiedColumns[] = CompanyPeer::COMP_NAME;
		}
	...
	public function setCompAddress($v)
	{
		...
		if ($this->comp_address !== $v) {
			$this->comp_address = $v;
			$this->modifiedColumns[] = CompanyPeer::COMP_ADDRESS;
		}
	...
	public function setCompHeader($v)
	{
		...
		if ($this->comp_header !== $v) {
			$this->comp_header = $v;
			$this->modifiedColumns[] = CompanyPeer::COMP_HEADER;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = CompanyPeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = CompanyPeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = CompanyPeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = CompanyPeer::DATE_MODIFIED;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyPeer::COMP_CODE)) $criteria->add(CompanyPeer::COMP_CODE, $this->comp_code);
		if ($this->isColumnModified(CompanyPeer::COMP_NAME)) $criteria->add(CompanyPeer::COMP_NAME, $this->comp_name);
		if ($this->isColumnModified(CompanyPeer::COMP_ADDRESS)) $criteria->add(CompanyPeer::COMP_ADDRESS, $this->comp_address);
		if ($this->isColumnModified(CompanyPeer::COMP_HEADER)) $criteria->add(CompanyPeer::COMP_HEADER, $this->comp_header);
		if ($this->isColumnModified(CompanyPeer::CREATED_BY)) $criteria->add(CompanyPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(CompanyPeer::DATE_CREATED)) $criteria->add(CompanyPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(CompanyPeer::MODIFIED_BY)) $criteria->add(CompanyPeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(CompanyPeer::DATE_MODIFIED)) $criteria->add(CompanyPeer::DATE_MODIFIED, $this->date_modified);
