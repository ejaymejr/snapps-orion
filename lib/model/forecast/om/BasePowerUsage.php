...
abstract class BasePowerUsage extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PowerUsagePeer::ID;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== $ts) {
			$this->date = $ts;
			$this->modifiedColumns[] = PowerUsagePeer::DATE;
		}
	...
	public function setTime($v)
	{
		...
		if ($this->time !== $ts) {
			$this->time = $ts;
			$this->modifiedColumns[] = PowerUsagePeer::TIME;
		}
	...
	public function setAmpm($v)
	{
		...
		if ($this->ampm !== $v || $v === 'am') {
			$this->ampm = $v;
			$this->modifiedColumns[] = PowerUsagePeer::AMPM;
		}
	...
	public function setReading($v)
	{
		...
		if ($this->reading !== $v) {
			$this->reading = $v;
			$this->modifiedColumns[] = PowerUsagePeer::READING;
		}
	...
	public function setConsumption($v)
	{
		...
		if ($this->consumption !== $v || $v === 0) {
			$this->consumption = $v;
			$this->modifiedColumns[] = PowerUsagePeer::CONSUMPTION;
		}
	...
	public function setUnit($v)
	{
		...
		if ($this->unit !== $v) {
			$this->unit = $v;
			$this->modifiedColumns[] = PowerUsagePeer::UNIT;
		}
	...
	public function setUnitPrice($v)
	{
		...
		if ($this->unit_price !== $v) {
			$this->unit_price = $v;
			$this->modifiedColumns[] = PowerUsagePeer::UNIT_PRICE;
		}
	...
	public function setConversionFactor($v)
	{
		...
		if ($this->conversion_factor !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = PowerUsagePeer::CONVERSION_FACTOR;
		}
	...
	public function setTotalCost($v)
	{
		...
		if ($this->total_cost !== $v) {
			$this->total_cost = $v;
			$this->modifiedColumns[] = PowerUsagePeer::TOTAL_COST;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = PowerUsagePeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = PowerUsagePeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = PowerUsagePeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = PowerUsagePeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PowerUsage object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PowerUsagePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PowerUsagePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PowerUsagePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PowerUsagePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PowerUsagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PowerUsagePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDate(),
			$keys[2] => $this->getTime(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PowerUsagePeer::ID)) $criteria->add(PowerUsagePeer::ID, $this->id);
		if ($this->isColumnModified(PowerUsagePeer::DATE)) $criteria->add(PowerUsagePeer::DATE, $this->date);
		if ($this->isColumnModified(PowerUsagePeer::TIME)) $criteria->add(PowerUsagePeer::TIME, $this->time);
		if ($this->isColumnModified(PowerUsagePeer::AMPM)) $criteria->add(PowerUsagePeer::AMPM, $this->ampm);
		if ($this->isColumnModified(PowerUsagePeer::READING)) $criteria->add(PowerUsagePeer::READING, $this->reading);
		if ($this->isColumnModified(PowerUsagePeer::CONSUMPTION)) $criteria->add(PowerUsagePeer::CONSUMPTION, $this->consumption);
		if ($this->isColumnModified(PowerUsagePeer::UNIT)) $criteria->add(PowerUsagePeer::UNIT, $this->unit);
		if ($this->isColumnModified(PowerUsagePeer::UNIT_PRICE)) $criteria->add(PowerUsagePeer::UNIT_PRICE, $this->unit_price);
		if ($this->isColumnModified(PowerUsagePeer::CONVERSION_FACTOR)) $criteria->add(PowerUsagePeer::CONVERSION_FACTOR, $this->conversion_factor);
		if ($this->isColumnModified(PowerUsagePeer::TOTAL_COST)) $criteria->add(PowerUsagePeer::TOTAL_COST, $this->total_cost);
		if ($this->isColumnModified(PowerUsagePeer::CREATED_BY)) $criteria->add(PowerUsagePeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(PowerUsagePeer::DATE_CREATED)) $criteria->add(PowerUsagePeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PowerUsagePeer::MODIFIED_BY)) $criteria->add(PowerUsagePeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(PowerUsagePeer::DATE_MODIFIED)) $criteria->add(PowerUsagePeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PowerUsagePeer::ID, $this->id);
