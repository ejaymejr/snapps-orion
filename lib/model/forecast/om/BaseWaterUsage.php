...
abstract class BaseWaterUsage extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = WaterUsagePeer::ID;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== $ts) {
			$this->date = $ts;
			$this->modifiedColumns[] = WaterUsagePeer::DATE;
		}
	...
	public function setTime($v)
	{
		...
		if ($this->time !== $ts) {
			$this->time = $ts;
			$this->modifiedColumns[] = WaterUsagePeer::TIME;
		}
	...
	public function setAmpm($v)
	{
		...
		if ($this->ampm !== $v || $v === 'am') {
			$this->ampm = $v;
			$this->modifiedColumns[] = WaterUsagePeer::AMPM;
		}
	...
	public function setReading($v)
	{
		...
		if ($this->reading !== $v || $v === 0) {
			$this->reading = $v;
			$this->modifiedColumns[] = WaterUsagePeer::READING;
		}
	...
	public function setConsumption($v)
	{
		...
		if ($this->consumption !== $v || $v === 0) {
			$this->consumption = $v;
			$this->modifiedColumns[] = WaterUsagePeer::CONSUMPTION;
		}
	...
	public function setUnit($v)
	{
		...
		if ($this->unit !== $v) {
			$this->unit = $v;
			$this->modifiedColumns[] = WaterUsagePeer::UNIT;
		}
	...
	public function setUnitPrice($v)
	{
		...
		if ($this->unit_price !== $v || $v === 0) {
			$this->unit_price = $v;
			$this->modifiedColumns[] = WaterUsagePeer::UNIT_PRICE;
		}
	...
	public function setConversionFactor($v)
	{
		...
		if ($this->conversion_factor !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = WaterUsagePeer::CONVERSION_FACTOR;
		}
	...
	public function setTotalCost($v)
	{
		...
		if ($this->total_cost !== $v || $v === 0) {
			$this->total_cost = $v;
			$this->modifiedColumns[] = WaterUsagePeer::TOTAL_COST;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = WaterUsagePeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = WaterUsagePeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = WaterUsagePeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = WaterUsagePeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating WaterUsage object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			WaterUsagePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WaterUsagePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += WaterUsagePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = WaterUsagePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = WaterUsagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = WaterUsagePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDate(),
			$keys[2] => $this->getTime(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WaterUsagePeer::ID)) $criteria->add(WaterUsagePeer::ID, $this->id);
		if ($this->isColumnModified(WaterUsagePeer::DATE)) $criteria->add(WaterUsagePeer::DATE, $this->date);
		if ($this->isColumnModified(WaterUsagePeer::TIME)) $criteria->add(WaterUsagePeer::TIME, $this->time);
		if ($this->isColumnModified(WaterUsagePeer::AMPM)) $criteria->add(WaterUsagePeer::AMPM, $this->ampm);
		if ($this->isColumnModified(WaterUsagePeer::READING)) $criteria->add(WaterUsagePeer::READING, $this->reading);
		if ($this->isColumnModified(WaterUsagePeer::CONSUMPTION)) $criteria->add(WaterUsagePeer::CONSUMPTION, $this->consumption);
		if ($this->isColumnModified(WaterUsagePeer::UNIT)) $criteria->add(WaterUsagePeer::UNIT, $this->unit);
		if ($this->isColumnModified(WaterUsagePeer::UNIT_PRICE)) $criteria->add(WaterUsagePeer::UNIT_PRICE, $this->unit_price);
		if ($this->isColumnModified(WaterUsagePeer::CONVERSION_FACTOR)) $criteria->add(WaterUsagePeer::CONVERSION_FACTOR, $this->conversion_factor);
		if ($this->isColumnModified(WaterUsagePeer::TOTAL_COST)) $criteria->add(WaterUsagePeer::TOTAL_COST, $this->total_cost);
		if ($this->isColumnModified(WaterUsagePeer::CREATED_BY)) $criteria->add(WaterUsagePeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(WaterUsagePeer::DATE_CREATED)) $criteria->add(WaterUsagePeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(WaterUsagePeer::MODIFIED_BY)) $criteria->add(WaterUsagePeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(WaterUsagePeer::DATE_MODIFIED)) $criteria->add(WaterUsagePeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(WaterUsagePeer::ID, $this->id);
