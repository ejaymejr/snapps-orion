...
class PayBasicPayPeer extends BasePayBasicPayPeer
{
    ...
    public static function GetPaidType()
    {
        return array('BANK'=>' BANK', 'CHEQUE'=>'CHEQUE', 'CASH'=>'CASH');
    }
    
    public static function TypeOfEmploymet()
    {
        return array('FULL-TIME'=>' FULLTIME', 'PART-TIME'=>'PART-TIME', 'SUB-CON'=>'SUB-CON');
    }
    
    public static function HasMcBenefit()
    {
        return array('N'=>'NO', 'Y'=>'YES');
    }
    
    public static function HasCPF()
    {
        return array('NO'=>'NO', 'YES'=>'YES');
    }
    
    public static function GetCpfCitizenship()
    {
    	return array('0'=>'Not Applicable', '1'=>'1st Year', '2' => '2nd year', '3'=> '3rd Year and Above');
    }
    ...
    public static function GetDatabyEmployeeNoWhoisInactive($empno)
    {
        $c = new Criteria();
        $c->add(self::EMPLOYEE_NO, $empno);
