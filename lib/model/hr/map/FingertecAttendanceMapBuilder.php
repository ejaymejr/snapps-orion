...
class FingertecAttendanceMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.FingertecAttendanceMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fingertec_attendance');
		$tMap->setPhpName('FingertecAttendance');
