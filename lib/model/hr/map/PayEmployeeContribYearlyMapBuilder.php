...
class PayEmployeeContribYearlyMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayEmployeeContribYearlyMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_employee_contrib_yearly');
		$tMap->setPhpName('PayEmployeeContribYearly');
