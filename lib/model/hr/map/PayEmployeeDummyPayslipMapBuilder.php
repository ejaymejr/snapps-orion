...
class PayEmployeeDummyPayslipMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayEmployeeDummyPayslipMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_employee_dummy_payslip');
		$tMap->setPhpName('PayEmployeeDummyPayslip');
