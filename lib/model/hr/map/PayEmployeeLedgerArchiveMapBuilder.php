...
class PayEmployeeLedgerArchiveMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayEmployeeLedgerArchiveMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_employee_ledger_archive');
		$tMap->setPhpName('PayEmployeeLedgerArchive');
