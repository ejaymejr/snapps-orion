...
class PayEmployeeLedgerMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayEmployeeLedgerMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_employee_ledger');
		$tMap->setPhpName('PayEmployeeLedger');
