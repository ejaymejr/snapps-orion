...
class PayEmployeeLedgerNanoTemplateMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayEmployeeLedgerNanoTemplateMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_employee_ledger_nano_template');
		$tMap->setPhpName('PayEmployeeLedgerNanoTemplate');
