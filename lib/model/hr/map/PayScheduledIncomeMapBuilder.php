...
class PayScheduledIncomeMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.PayScheduledIncomeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pay_scheduled_income');
		$tMap->setPhpName('PayScheduledIncome');
		...
		$tMap->addColumn('TOT_AMT_RECEIVED', 'TotAmtReceived', 'double', CreoleTypes::FLOAT, false, 9);
