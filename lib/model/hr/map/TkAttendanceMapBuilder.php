...
class TkAttendanceMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.TkAttendanceMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tk_attendance');
		$tMap->setPhpName('TkAttendance');
