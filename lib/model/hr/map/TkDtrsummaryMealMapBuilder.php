...
class TkDtrsummaryMealMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.TkDtrsummaryMealMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tk_dtrsummary_meal');
		$tMap->setPhpName('TkDtrsummaryMeal');
