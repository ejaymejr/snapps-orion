...
class TkMealSummaryMapBuilder {

	
	const CLASS_NAME = 'lib.model.hr.map.TkMealSummaryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tk_meal_summary');
		$tMap->setPhpName('TkMealSummary');
