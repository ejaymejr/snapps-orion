...
abstract class BaseFingertecAttendanceLog extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::ID;
		}
	...
	public function setEmployeeNo($v)
	{
		...
		if ($this->employee_no !== $v) {
			$this->employee_no = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::EMPLOYEE_NO;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::NAME;
		}
	...
	public function setTransDate($v)
	{
		...
		if ($this->trans_date !== $ts) {
			$this->trans_date = $ts;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::TRANS_DATE;
		}
	...
	public function setEnrollNo($v)
	{
		...
		if ($this->enroll_no !== $v || $v === '0') {
			$this->enroll_no = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::ENROLL_NO;
		}
	...
	public function setMachineNo($v)
	{
		...
		if ($this->machine_no !== $v || $v === '0') {
			$this->machine_no = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::MACHINE_NO;
		}
	...
	public function setIsProcessed($v)
	{
		...
		if ($this->is_processed !== $v) {
			$this->is_processed = $v;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::IS_PROCESSED;
		}
	...
	public function setDateDump($v)
	{
		...
		if ($this->date_dump !== $ts) {
			$this->date_dump = $ts;
			$this->modifiedColumns[] = FingertecAttendanceLogPeer::DATE_DUMP;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating FingertecAttendanceLog object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FingertecAttendanceLogPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FingertecAttendanceLogPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += FingertecAttendanceLogPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FingertecAttendanceLogPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FingertecAttendanceLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FingertecAttendanceLogPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FingertecAttendanceLogPeer::ID)) $criteria->add(FingertecAttendanceLogPeer::ID, $this->id);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::EMPLOYEE_NO)) $criteria->add(FingertecAttendanceLogPeer::EMPLOYEE_NO, $this->employee_no);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::NAME)) $criteria->add(FingertecAttendanceLogPeer::NAME, $this->name);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::TRANS_DATE)) $criteria->add(FingertecAttendanceLogPeer::TRANS_DATE, $this->trans_date);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::ENROLL_NO)) $criteria->add(FingertecAttendanceLogPeer::ENROLL_NO, $this->enroll_no);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::MACHINE_NO)) $criteria->add(FingertecAttendanceLogPeer::MACHINE_NO, $this->machine_no);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::IS_PROCESSED)) $criteria->add(FingertecAttendanceLogPeer::IS_PROCESSED, $this->is_processed);
		if ($this->isColumnModified(FingertecAttendanceLogPeer::DATE_DUMP)) $criteria->add(FingertecAttendanceLogPeer::DATE_DUMP, $this->date_dump);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FingertecAttendanceLogPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new FingertecAttendanceLogPeer();
		}
		return self::$peer;
	}
