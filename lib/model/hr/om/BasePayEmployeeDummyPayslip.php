...
abstract class BasePayEmployeeDummyPayslip extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::ID;
		}
	...
	public function setEmployeeNo($v)
	{
		...
		if ($this->employee_no !== $v || $v === 'null') {
			$this->employee_no = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::EMPLOYEE_NO;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::NAME;
		}
	...
	public function setDepartment($v)
	{
		...
		if ($this->department !== $v) {
			$this->department = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::DEPARTMENT;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::COMPANY;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v) {
			$this->frequency = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::FREQUENCY;
		}
	...
	public function setPeriodCode($v)
	{
		...
		if ($this->period_code !== $v) {
			$this->period_code = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::PERIOD_CODE;
		}
	...
	public function setAcctCode($v)
	{
		...
		if ($this->acct_code !== $v) {
			$this->acct_code = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::ACCT_CODE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::DESCRIPTION;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::AMOUNT;
		}
	...
	public function setPayScheduledIncomeId($v)
	{
		...
		if ($this->pay_scheduled_income_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_INCOME_ID;
		}
	...
	public function setPayScheduledDeductionId($v)
	{
		...
		if ($this->pay_scheduled_deduction_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_DEDUCTION_ID;
		}
	...
	public function setIncomeExpense($v)
	{
		...
		if ($this->income_expense !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::INCOME_EXPENSE;
		}
	...
	public function setAcctSource($v)
	{
		...
		if ($this->acct_source !== $v) {
			$this->acct_source = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::ACCT_SOURCE;
		}
	...
	public function setProcessedAs($v)
	{
		...
		if ($this->processed_as !== $v) {
			$this->processed_as = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::PROCESSED_AS;
		}
	...
	public function setTaxCode($v)
	{
		...
		if ($this->tax_code !== $v) {
			$this->tax_code = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::TAX_CODE;
		}
	...
	public function setTaxableAmount($v)
	{
		...
		if ($this->taxable_amount !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::TAXABLE_AMOUNT;
		}
	...
	public function setCpfTotal($v)
	{
		...
		if ($this->cpf_total !== $v || $v === 0) {
			$this->cpf_total = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::CPF_TOTAL;
		}
	...
	public function setCpfEr($v)
	{
		...
		if ($this->cpf_er !== $v || $v === 0) {
			$this->cpf_er = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::CPF_ER;
		}
	...
	public function setIsPayslipPrinted($v)
	{
		...
		if ($this->is_payslip_printed !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::IS_PAYSLIP_PRINTED;
		}
	...
	public function setRace($v)
	{
		...
		if ($this->race !== $v) {
			$this->race = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::RACE;
		}
	...
	public function setBankCash($v)
	{
		...
		if ($this->bank_cash !== $v) {
			$this->bank_cash = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::BANK_CASH;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeDummyPayslipPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PayEmployeeDummyPayslip object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PayEmployeeDummyPayslipPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PayEmployeeDummyPayslipPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PayEmployeeDummyPayslipPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PayEmployeeDummyPayslipPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PayEmployeeDummyPayslipPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PayEmployeeDummyPayslipPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::ID)) $criteria->add(PayEmployeeDummyPayslipPeer::ID, $this->id);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::EMPLOYEE_NO)) $criteria->add(PayEmployeeDummyPayslipPeer::EMPLOYEE_NO, $this->employee_no);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::NAME)) $criteria->add(PayEmployeeDummyPayslipPeer::NAME, $this->name);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::DEPARTMENT)) $criteria->add(PayEmployeeDummyPayslipPeer::DEPARTMENT, $this->department);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::COMPANY)) $criteria->add(PayEmployeeDummyPayslipPeer::COMPANY, $this->company);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::FREQUENCY)) $criteria->add(PayEmployeeDummyPayslipPeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::PERIOD_CODE)) $criteria->add(PayEmployeeDummyPayslipPeer::PERIOD_CODE, $this->period_code);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::ACCT_CODE)) $criteria->add(PayEmployeeDummyPayslipPeer::ACCT_CODE, $this->acct_code);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::DESCRIPTION)) $criteria->add(PayEmployeeDummyPayslipPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::AMOUNT)) $criteria->add(PayEmployeeDummyPayslipPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_INCOME_ID)) $criteria->add(PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_INCOME_ID, $this->pay_scheduled_income_id);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_DEDUCTION_ID)) $criteria->add(PayEmployeeDummyPayslipPeer::PAY_SCHEDULED_DEDUCTION_ID, $this->pay_scheduled_deduction_id);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::INCOME_EXPENSE)) $criteria->add(PayEmployeeDummyPayslipPeer::INCOME_EXPENSE, $this->income_expense);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::ACCT_SOURCE)) $criteria->add(PayEmployeeDummyPayslipPeer::ACCT_SOURCE, $this->acct_source);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::PROCESSED_AS)) $criteria->add(PayEmployeeDummyPayslipPeer::PROCESSED_AS, $this->processed_as);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::TAX_CODE)) $criteria->add(PayEmployeeDummyPayslipPeer::TAX_CODE, $this->tax_code);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::TAXABLE_AMOUNT)) $criteria->add(PayEmployeeDummyPayslipPeer::TAXABLE_AMOUNT, $this->taxable_amount);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::CPF_TOTAL)) $criteria->add(PayEmployeeDummyPayslipPeer::CPF_TOTAL, $this->cpf_total);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::CPF_ER)) $criteria->add(PayEmployeeDummyPayslipPeer::CPF_ER, $this->cpf_er);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::IS_PAYSLIP_PRINTED)) $criteria->add(PayEmployeeDummyPayslipPeer::IS_PAYSLIP_PRINTED, $this->is_payslip_printed);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::RACE)) $criteria->add(PayEmployeeDummyPayslipPeer::RACE, $this->race);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::BANK_CASH)) $criteria->add(PayEmployeeDummyPayslipPeer::BANK_CASH, $this->bank_cash);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::CREATED_BY)) $criteria->add(PayEmployeeDummyPayslipPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::DATE_CREATED)) $criteria->add(PayEmployeeDummyPayslipPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::MODIFIED_BY)) $criteria->add(PayEmployeeDummyPayslipPeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(PayEmployeeDummyPayslipPeer::DATE_MODIFIED)) $criteria->add(PayEmployeeDummyPayslipPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PayEmployeeDummyPayslipPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new PayEmployeeDummyPayslipPeer();
		}
		return self::$peer;
	}
