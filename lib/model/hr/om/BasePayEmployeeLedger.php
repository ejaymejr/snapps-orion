...
abstract class BasePayEmployeeLedger extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::ID;
		}
	...
	public function setEmployeeNo($v)
	{
		...
		if ($this->employee_no !== $v || $v === 'null') {
			$this->employee_no = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::EMPLOYEE_NO;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::NAME;
		}
	...
	public function setDepartment($v)
	{
		...
		if ($this->department !== $v) {
			$this->department = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::DEPARTMENT;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::COMPANY;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v) {
			$this->frequency = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::FREQUENCY;
		}
	...
	public function setPeriodCode($v)
	{
		...
		if ($this->period_code !== $v) {
			$this->period_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::PERIOD_CODE;
		}
	...
	public function setAcctCode($v)
	{
		...
		if ($this->acct_code !== $v) {
			$this->acct_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::ACCT_CODE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::DESCRIPTION;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::AMOUNT;
		}
	...
	public function setPayScheduledIncomeId($v)
	{
		...
		if ($this->pay_scheduled_income_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::PAY_SCHEDULED_INCOME_ID;
		}
	...
	public function setPayScheduledDeductionId($v)
	{
		...
		if ($this->pay_scheduled_deduction_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::PAY_SCHEDULED_DEDUCTION_ID;
		}
	...
	public function setIncomeExpense($v)
	{
		...
		if ($this->income_expense !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::INCOME_EXPENSE;
		}
	...
	public function setAcctSource($v)
	{
		...
		if ($this->acct_source !== $v) {
			$this->acct_source = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::ACCT_SOURCE;
		}
	...
	public function setProcessedAs($v)
	{
		...
		if ($this->processed_as !== $v) {
			$this->processed_as = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::PROCESSED_AS;
		}
	...
	public function setTaxCode($v)
	{
		...
		if ($this->tax_code !== $v) {
			$this->tax_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::TAX_CODE;
		}
	...
	public function setTaxableAmount($v)
	{
		...
		if ($this->taxable_amount !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::TAXABLE_AMOUNT;
		}
	...
	public function setCpfTotal($v)
	{
		...
		if ($this->cpf_total !== $v || $v === 0) {
			$this->cpf_total = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::CPF_TOTAL;
		}
	...
	public function setCpfEr($v)
	{
		...
		if ($this->cpf_er !== $v || $v === 0) {
			$this->cpf_er = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::CPF_ER;
		}
	...
	public function setIsPayslipPrinted($v)
	{
		...
		if ($this->is_payslip_printed !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::IS_PAYSLIP_PRINTED;
		}
	...
	public function setRace($v)
	{
		...
		if ($this->race !== $v) {
			$this->race = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::RACE;
		}
	...
	public function setBankCash($v)
	{
		...
		if ($this->bank_cash !== $v) {
			$this->bank_cash = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::BANK_CASH;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PayEmployeeLedger object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PayEmployeeLedgerPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PayEmployeeLedgerPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PayEmployeeLedgerPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PayEmployeeLedgerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PayEmployeeLedgerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PayEmployeeLedgerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PayEmployeeLedgerPeer::ID)) $criteria->add(PayEmployeeLedgerPeer::ID, $this->id);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::EMPLOYEE_NO)) $criteria->add(PayEmployeeLedgerPeer::EMPLOYEE_NO, $this->employee_no);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::NAME)) $criteria->add(PayEmployeeLedgerPeer::NAME, $this->name);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::DEPARTMENT)) $criteria->add(PayEmployeeLedgerPeer::DEPARTMENT, $this->department);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::COMPANY)) $criteria->add(PayEmployeeLedgerPeer::COMPANY, $this->company);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::FREQUENCY)) $criteria->add(PayEmployeeLedgerPeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::PERIOD_CODE)) $criteria->add(PayEmployeeLedgerPeer::PERIOD_CODE, $this->period_code);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::ACCT_CODE)) $criteria->add(PayEmployeeLedgerPeer::ACCT_CODE, $this->acct_code);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::DESCRIPTION)) $criteria->add(PayEmployeeLedgerPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::AMOUNT)) $criteria->add(PayEmployeeLedgerPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::PAY_SCHEDULED_INCOME_ID)) $criteria->add(PayEmployeeLedgerPeer::PAY_SCHEDULED_INCOME_ID, $this->pay_scheduled_income_id);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::PAY_SCHEDULED_DEDUCTION_ID)) $criteria->add(PayEmployeeLedgerPeer::PAY_SCHEDULED_DEDUCTION_ID, $this->pay_scheduled_deduction_id);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::INCOME_EXPENSE)) $criteria->add(PayEmployeeLedgerPeer::INCOME_EXPENSE, $this->income_expense);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::ACCT_SOURCE)) $criteria->add(PayEmployeeLedgerPeer::ACCT_SOURCE, $this->acct_source);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::PROCESSED_AS)) $criteria->add(PayEmployeeLedgerPeer::PROCESSED_AS, $this->processed_as);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::TAX_CODE)) $criteria->add(PayEmployeeLedgerPeer::TAX_CODE, $this->tax_code);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::TAXABLE_AMOUNT)) $criteria->add(PayEmployeeLedgerPeer::TAXABLE_AMOUNT, $this->taxable_amount);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::CPF_TOTAL)) $criteria->add(PayEmployeeLedgerPeer::CPF_TOTAL, $this->cpf_total);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::CPF_ER)) $criteria->add(PayEmployeeLedgerPeer::CPF_ER, $this->cpf_er);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::IS_PAYSLIP_PRINTED)) $criteria->add(PayEmployeeLedgerPeer::IS_PAYSLIP_PRINTED, $this->is_payslip_printed);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::RACE)) $criteria->add(PayEmployeeLedgerPeer::RACE, $this->race);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::BANK_CASH)) $criteria->add(PayEmployeeLedgerPeer::BANK_CASH, $this->bank_cash);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::CREATED_BY)) $criteria->add(PayEmployeeLedgerPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::DATE_CREATED)) $criteria->add(PayEmployeeLedgerPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::MODIFIED_BY)) $criteria->add(PayEmployeeLedgerPeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(PayEmployeeLedgerPeer::DATE_MODIFIED)) $criteria->add(PayEmployeeLedgerPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PayEmployeeLedgerPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new PayEmployeeLedgerPeer();
		}
		return self::$peer;
	}
