...
abstract class BasePayEmployeeLedgerArchive extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::ID;
		}
	...
	public function setEmployeeNo($v)
	{
		...
		if ($this->employee_no !== $v || $v === 'null') {
			$this->employee_no = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::EMPLOYEE_NO;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::NAME;
		}
	...
	public function setDepartment($v)
	{
		...
		if ($this->department !== $v) {
			$this->department = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::DEPARTMENT;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::COMPANY;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v) {
			$this->frequency = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::FREQUENCY;
		}
	...
	public function setPeriodCode($v)
	{
		...
		if ($this->period_code !== $v) {
			$this->period_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::PERIOD_CODE;
		}
	...
	public function setAcctCode($v)
	{
		...
		if ($this->acct_code !== $v) {
			$this->acct_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::ACCT_CODE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::DESCRIPTION;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::AMOUNT;
		}
	...
	public function setPayScheduledIncomeId($v)
	{
		...
		if ($this->pay_scheduled_income_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_INCOME_ID;
		}
	...
	public function setPayScheduledDeductionId($v)
	{
		...
		if ($this->pay_scheduled_deduction_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_DEDUCTION_ID;
		}
	...
	public function setIncomeExpense($v)
	{
		...
		if ($this->income_expense !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::INCOME_EXPENSE;
		}
	...
	public function setAcctSource($v)
	{
		...
		if ($this->acct_source !== $v) {
			$this->acct_source = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::ACCT_SOURCE;
		}
	...
	public function setProcessedAs($v)
	{
		...
		if ($this->processed_as !== $v) {
			$this->processed_as = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::PROCESSED_AS;
		}
	...
	public function setTaxCode($v)
	{
		...
		if ($this->tax_code !== $v) {
			$this->tax_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::TAX_CODE;
		}
	...
	public function setTaxableAmount($v)
	{
		...
		if ($this->taxable_amount !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::TAXABLE_AMOUNT;
		}
	...
	public function setCpfTotal($v)
	{
		...
		if ($this->cpf_total !== $v || $v === 0) {
			$this->cpf_total = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::CPF_TOTAL;
		}
	...
	public function setCpfEr($v)
	{
		...
		if ($this->cpf_er !== $v || $v === 0) {
			$this->cpf_er = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::CPF_ER;
		}
	...
	public function setIsPayslipPrinted($v)
	{
		...
		if ($this->is_payslip_printed !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::IS_PAYSLIP_PRINTED;
		}
	...
	public function setRace($v)
	{
		...
		if ($this->race !== $v) {
			$this->race = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::RACE;
		}
	...
	public function setBankCash($v)
	{
		...
		if ($this->bank_cash !== $v) {
			$this->bank_cash = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::BANK_CASH;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerArchivePeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PayEmployeeLedgerArchive object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PayEmployeeLedgerArchivePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PayEmployeeLedgerArchivePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PayEmployeeLedgerArchivePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PayEmployeeLedgerArchivePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PayEmployeeLedgerArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PayEmployeeLedgerArchivePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::ID)) $criteria->add(PayEmployeeLedgerArchivePeer::ID, $this->id);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::EMPLOYEE_NO)) $criteria->add(PayEmployeeLedgerArchivePeer::EMPLOYEE_NO, $this->employee_no);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::NAME)) $criteria->add(PayEmployeeLedgerArchivePeer::NAME, $this->name);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::DEPARTMENT)) $criteria->add(PayEmployeeLedgerArchivePeer::DEPARTMENT, $this->department);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::COMPANY)) $criteria->add(PayEmployeeLedgerArchivePeer::COMPANY, $this->company);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::FREQUENCY)) $criteria->add(PayEmployeeLedgerArchivePeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::PERIOD_CODE)) $criteria->add(PayEmployeeLedgerArchivePeer::PERIOD_CODE, $this->period_code);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::ACCT_CODE)) $criteria->add(PayEmployeeLedgerArchivePeer::ACCT_CODE, $this->acct_code);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::DESCRIPTION)) $criteria->add(PayEmployeeLedgerArchivePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::AMOUNT)) $criteria->add(PayEmployeeLedgerArchivePeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_INCOME_ID)) $criteria->add(PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_INCOME_ID, $this->pay_scheduled_income_id);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_DEDUCTION_ID)) $criteria->add(PayEmployeeLedgerArchivePeer::PAY_SCHEDULED_DEDUCTION_ID, $this->pay_scheduled_deduction_id);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::INCOME_EXPENSE)) $criteria->add(PayEmployeeLedgerArchivePeer::INCOME_EXPENSE, $this->income_expense);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::ACCT_SOURCE)) $criteria->add(PayEmployeeLedgerArchivePeer::ACCT_SOURCE, $this->acct_source);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::PROCESSED_AS)) $criteria->add(PayEmployeeLedgerArchivePeer::PROCESSED_AS, $this->processed_as);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::TAX_CODE)) $criteria->add(PayEmployeeLedgerArchivePeer::TAX_CODE, $this->tax_code);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::TAXABLE_AMOUNT)) $criteria->add(PayEmployeeLedgerArchivePeer::TAXABLE_AMOUNT, $this->taxable_amount);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::CPF_TOTAL)) $criteria->add(PayEmployeeLedgerArchivePeer::CPF_TOTAL, $this->cpf_total);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::CPF_ER)) $criteria->add(PayEmployeeLedgerArchivePeer::CPF_ER, $this->cpf_er);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::IS_PAYSLIP_PRINTED)) $criteria->add(PayEmployeeLedgerArchivePeer::IS_PAYSLIP_PRINTED, $this->is_payslip_printed);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::RACE)) $criteria->add(PayEmployeeLedgerArchivePeer::RACE, $this->race);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::BANK_CASH)) $criteria->add(PayEmployeeLedgerArchivePeer::BANK_CASH, $this->bank_cash);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::CREATED_BY)) $criteria->add(PayEmployeeLedgerArchivePeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::DATE_CREATED)) $criteria->add(PayEmployeeLedgerArchivePeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::MODIFIED_BY)) $criteria->add(PayEmployeeLedgerArchivePeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(PayEmployeeLedgerArchivePeer::DATE_MODIFIED)) $criteria->add(PayEmployeeLedgerArchivePeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PayEmployeeLedgerArchivePeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new PayEmployeeLedgerArchivePeer();
		}
		return self::$peer;
	}
