...
abstract class BasePayEmployeeLedgerNanoTemplate extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::ID;
		}
	...
	public function setEmployeeNo($v)
	{
		...
		if ($this->employee_no !== $v || $v === 'null') {
			$this->employee_no = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::EMPLOYEE_NO;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::NAME;
		}
	...
	public function setDepartment($v)
	{
		...
		if ($this->department !== $v) {
			$this->department = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::DEPARTMENT;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::COMPANY;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v) {
			$this->frequency = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::FREQUENCY;
		}
	...
	public function setPeriodCode($v)
	{
		...
		if ($this->period_code !== $v) {
			$this->period_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::PERIOD_CODE;
		}
	...
	public function setAcctCode($v)
	{
		...
		if ($this->acct_code !== $v) {
			$this->acct_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::ACCT_CODE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::DESCRIPTION;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::AMOUNT;
		}
	...
	public function setPayScheduledIncomeId($v)
	{
		...
		if ($this->pay_scheduled_income_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_INCOME_ID;
		}
	...
	public function setPayScheduledDeductionId($v)
	{
		...
		if ($this->pay_scheduled_deduction_id !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_DEDUCTION_ID;
		}
	...
	public function setIncomeExpense($v)
	{
		...
		if ($this->income_expense !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::INCOME_EXPENSE;
		}
	...
	public function setAcctSource($v)
	{
		...
		if ($this->acct_source !== $v) {
			$this->acct_source = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::ACCT_SOURCE;
		}
	...
	public function setProcessedAs($v)
	{
		...
		if ($this->processed_as !== $v) {
			$this->processed_as = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::PROCESSED_AS;
		}
	...
	public function setTaxCode($v)
	{
		...
		if ($this->tax_code !== $v) {
			$this->tax_code = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::TAX_CODE;
		}
	...
	public function setTaxableAmount($v)
	{
		...
		if ($this->taxable_amount !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::TAXABLE_AMOUNT;
		}
	...
	public function setCpfTotal($v)
	{
		...
		if ($this->cpf_total !== $v || $v === 0) {
			$this->cpf_total = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::CPF_TOTAL;
		}
	...
	public function setCpfEr($v)
	{
		...
		if ($this->cpf_er !== $v || $v === 0) {
			$this->cpf_er = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::CPF_ER;
		}
	...
	public function setIsPayslipPrinted($v)
	{
		...
		if ($this->is_payslip_printed !== $v) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::IS_PAYSLIP_PRINTED;
		}
	...
	public function setRace($v)
	{
		...
		if ($this->race !== $v) {
			$this->race = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::RACE;
		}
	...
	public function setBankCash($v)
	{
		...
		if ($this->bank_cash !== $v) {
			$this->bank_cash = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::BANK_CASH;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::CREATED_BY;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::DATE_CREATED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::MODIFIED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = PayEmployeeLedgerNanoTemplatePeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating PayEmployeeLedgerNanoTemplate object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PayEmployeeLedgerNanoTemplatePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PayEmployeeLedgerNanoTemplatePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += PayEmployeeLedgerNanoTemplatePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PayEmployeeLedgerNanoTemplatePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PayEmployeeLedgerNanoTemplatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PayEmployeeLedgerNanoTemplatePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::ID)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::ID, $this->id);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::EMPLOYEE_NO)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::EMPLOYEE_NO, $this->employee_no);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::NAME)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::NAME, $this->name);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::DEPARTMENT)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::DEPARTMENT, $this->department);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::COMPANY)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::COMPANY, $this->company);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::FREQUENCY)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::PERIOD_CODE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::PERIOD_CODE, $this->period_code);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::ACCT_CODE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::ACCT_CODE, $this->acct_code);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::DESCRIPTION)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::AMOUNT)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_INCOME_ID)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_INCOME_ID, $this->pay_scheduled_income_id);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_DEDUCTION_ID)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::PAY_SCHEDULED_DEDUCTION_ID, $this->pay_scheduled_deduction_id);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::INCOME_EXPENSE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::INCOME_EXPENSE, $this->income_expense);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::ACCT_SOURCE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::ACCT_SOURCE, $this->acct_source);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::PROCESSED_AS)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::PROCESSED_AS, $this->processed_as);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::TAX_CODE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::TAX_CODE, $this->tax_code);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::TAXABLE_AMOUNT)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::TAXABLE_AMOUNT, $this->taxable_amount);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::CPF_TOTAL)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::CPF_TOTAL, $this->cpf_total);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::CPF_ER)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::CPF_ER, $this->cpf_er);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::IS_PAYSLIP_PRINTED)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::IS_PAYSLIP_PRINTED, $this->is_payslip_printed);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::RACE)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::RACE, $this->race);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::BANK_CASH)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::BANK_CASH, $this->bank_cash);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::CREATED_BY)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::DATE_CREATED)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::MODIFIED_BY)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::MODIFIED_BY, $this->modified_by);
		if ($this->isColumnModified(PayEmployeeLedgerNanoTemplatePeer::DATE_MODIFIED)) $criteria->add(PayEmployeeLedgerNanoTemplatePeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PayEmployeeLedgerNanoTemplatePeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new PayEmployeeLedgerNanoTemplatePeer();
		}
		return self::$peer;
	}
