...
//$files = array('html', 'grid', 'menu',  'global_dashboard', 'layout', 'auxiliary_panel', 'calendar', 'bigtable', 'sortabletable', 'search', 'yui', 'customer','hr', 'conveyor', 'anylinkmenu');

$files = array(
		'metro-bootstrap-responsive', 'metro-bootstrap',
		'../js/metroui/prettify/prettify',
		'../flare/js/pe.flare/jquery.pixelentity.flare.min',
 		'layout', 'eman', 'docs', 'loader',
		'dataTables', 'select2',
		'metro-icons'
		//'iconFont',
		);
...
//$css = file_get_contents('layout.css');
