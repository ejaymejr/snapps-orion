<head>
    ...
    <script src="../js/metroui/jquery/jquery.easing.1.3.min.js"></script>
	<script src="../js/metroui/jquery/jquery.dataTables.js"></script>
    <!-- Metro UI CSS JavaScript plugins -->
    <script src="../js/metroui/metro.min.js"></script>
    <script src="../js/metroui/metro/metro-loader.js"></script>
