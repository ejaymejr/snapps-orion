...
var TableToolsInit = {
	...
	"sPrintMessage": "",
	"sTitle": "",
	"sSwfPath": "http://orion.micronclean/orion/json/ZeroClipboard.swf", //"../js/metroui/jquery/ZeroClipboard.swf"
	"iButtonHeight": 30,
	"iButtonWidth": 30,
...
function TableTools ( oInit )
{
	...
	function fnFeatureSaveXLS ()
	{
		var sBaseClass = "success ";
		var nButton = document.createElement( 'BUTTON' );
		nButton.id = "ToolTables_XLS_"+_iId;
		nButton.style.height = _oSettings.iButtonHeight+'px';
		nButton.style.width = _oSettings.iButtonWidth+'px';
		nButton.className = sBaseClass;
		var iconObject = document.createElement( 'i' );
		iconObject.className = "icon-file-excel";
		nButton.appendChild(iconObject );
		_nTools.appendChild( nButton );

		_nTools.appendChild( document.createTextNode( '\u00A0' ) );
		...
		clip.addEventListener('mouseOver', function(client) {
			nButton.className = sBaseClass+' bg-orange ';
		} );
	...
	function fnFeatureClipboard ()
	{
		...
		nButton.className = sBaseClass;
		var iconObject = document.createElement( 'i' );
		iconObject.className = "icon-clipboard-2";
		nButton.appendChild(iconObject );
		_nTools.appendChild( nButton );
	...
	function fnFeaturePrint ()
	{
		var sBaseClass = "success TableTools_PrintInfo";
		var nButton = document.createElement( 'BUTTON' );
		nButton.style.height = _oSettings.iButtonHeight+'px';
		nButton.style.width = _oSettings.iButtonWidth+'px';
		nButton.className = sBaseClass;
		...
		var iconObject = document.createElement( 'i' );
		iconObject.className = "icon-printer";
		nButton.appendChild(iconObject );
		_nTools.appendChild( nButton );
		_nTools.appendChild( document.createTextNode( '\u00A0' ) );
